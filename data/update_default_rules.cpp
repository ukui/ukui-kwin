...
// read additional window rules and add them to ukui-kwinrulesrc
...
int main( int argc, char* argv[] )
    ...
    QCoreApplication::setApplicationName ("ukui_kwin_update_default_rules");

    QString file = QStandardPaths::locate(QStandardPaths::GenericDataLocation, QString( "ukui-kwin/default_rules/%1" ).arg(argv[ 1 ] ));
    if( file.isEmpty())
        {
    ...
    KConfig dest_cfg("ukui-kwinrulesrc", KConfig::NoGlobals);
